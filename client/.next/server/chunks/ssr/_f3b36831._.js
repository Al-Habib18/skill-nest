...
"[project]/src/app/(dashboad)/user/courses/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Courses = ()=>{
    ...
    const { data: courses, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetUserEnrolledCoursesQuery"])(user?.id ?? "", {
        skip: !isLoaded || !user
    });
    ...
    if (isError || !courses || courses.length === 0) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_f3b36831._.js.map