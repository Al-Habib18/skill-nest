...
const TeacherCourseCard = ({
    ...
    return (
        <div className=" m-2">
            <Card className="w-full h-[400px] p-0 bg-background border-none text-foreground bg-gray-900 m-2 overflow-hidden hover:bg-white-100/10 transition duration-200 flex flex-col group">
